...
/* Added by Stomy 2022-10-03 */
static char*
json_parse_error_toString(enum json_parse_error_e e)
{
    switch (e) {
        case json_parse_error_none:                                 return "No Error";
        case json_parse_error_expected_comma_or_closing_bracket:    return "Comma or closing bracket expected";
        case json_parse_error_expected_colon:                       return "Colon expected";
        case json_parse_error_expected_opening_quote:               return "Opening quote expected";
        case json_parse_error_invalid_string_escape_sequence:       return "Invalid string escape sequence";
        case json_parse_error_invalid_number_format:                return "Invalid number format";
        case json_parse_error_invalid_value:                        return "Invalid value";
        case json_parse_error_invalid_string:                       return "Invalid string";
        case json_parse_error_premature_end_of_buffer:              return "Premature end of buffer";
        case json_parse_error_allocator_failed:                     return "Failed call to allocator";
        case json_parse_error_unexpected_trailing_characters:       return "Unexpected trailing characters";
        default:                                                    return "Unknown error";
    }
}

static char*
json_type_toString(enum json_type_e t)
{
    switch (t) {
